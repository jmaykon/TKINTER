...
class Ventana(Frame):  # Herencia Frame <-- Ventana

    def __init__(self, master=None):  # Contructor de Ventana
        super().__init__(master, width=680, height=260)  # Herencia constructor de Frame = master
    ...
    def create_widgets(self):
        ...
        # self.variable  ,puede llamarse desde fuera del metodo(miembros de la clase)
