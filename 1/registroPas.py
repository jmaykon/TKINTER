...
class Registro(Frame):  # Herencia Frame <-- Ventana
    ...
    def fGuardar(self):
        if self.id == -1:
            self.p1.registra_pasante(self.cajaTxt_ci.get(), self.cajaTxt_nom.get(), self.cajaTxt_ap_pat.get(), self.cajaTxt_ap_mat.get(),
                                     self.var_carrera.get(), self.var_area.get(), self.cajaTxt_cel.get(), self.var_tipoC.get(), self.cajaTxt_fechaIni.get(),
                                     self.cajaTxt_fechaFin.get(), self.var_turno.get(), self.cajaTxt_gestion.get())
            messagebox.showinfo("Insertar", "Elemento insertado correctamente")
        else:
            self.p1.modificar_pasante(self.id, self.cajaTxt_ci.get(), self.cajaTxt_nom.get(), self.cajaTxt_ap_pat.get(), self.cajaTxt_ap_mat.get(),
                                      self.var_carrera.get(), self.var_area.get(), self.cajaTxt_cel.get(), self.var_tipoC.get(), self.cajaTxt_fechaIni.get(),
                                      self.cajaTxt_fechaFin.get(), self.var_turno.get(), self.cajaTxt_gestion.get())
    ...
    def create_widgets(self):
        ...
        self.grid.heading("col8", text="T.Contrato", anchor=CENTER)
        ...
        self.grid.heading("col12", text="Gestion", anchor=CENTER)
