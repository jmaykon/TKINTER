...
class Pasante:
    ...
    def registra_pasante(self, ci, nombre, apPat, apMat , carrera, area, cel, fechaini, fechafin, turno, gestion):
        ...
        VALUES('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')'''.format(ci, nombre, apPat, apMat, carrera, area, cel, fechaini, fechafin, turno, gestion)
        cur.execute(sql)
        n = cur.rowcount
        self.cnn.commit()
        cur.close()
    ...
    def modificar_pasante(self, id, ci, nom, appat, apmat, carr, area, cel, fechaini, fechafin, turno, gestion):
        ...
        area = '{}', cel = '{}', fechaini = '{}', fechafin = '{}', turno = '{}', gestion = '{}' WHERE id = {} '''.format(ci, nom, appat, apmat, carr, area, cel, fechaini, fechafin, turno, gestion, id)
        cur.execute(sql)
        n = cur.rowcount
        self.cnn.commit()
        cur.close()
