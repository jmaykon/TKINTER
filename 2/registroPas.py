...
class Registro(Frame):  # Herencia Frame <-- Ventana
    ...
    def habilitarCaja(self, estado):
        ...
        self.opcionCA.configure(state=estado)
        self.opcionA.configure(state=estado)
        ...
        self.opcionT.configure(state=estado)
    ...
    def fGuardar(self):
        if self.id == -1:
            self.p1.registra_pasante(self.cajaTxt_ci.get(), self.cajaTxt_nom.get(), self.cajaTxt_ap_pat.get(), self.cajaTxt_ap_mat.get(), self.var_carrera.get(), self.var_area.get(), self.cajaTxt_cel.get(), self.var_tipoC.get(), self.cajaTxt_fechaIni.get(), self.cajaTxt_fechaFin.get(), self.var_turno.get(), self.cajaTxt_gestion.get())
            messagebox.showinfo("Insertar", "Elemento insertado correctamente")
        else:
            self.p1.modificar_pasante(self.id, self.cajaTxt_ci.get(), self.cajaTxt_nom.get(), self.cajaTxt_ap_pat.get(), self.cajaTxt_ap_mat.get(), self.var_carrera.get(), self.var_area.get(), self.cajaTxt_cel.get(), self.var_tipoC.get(), self.cajaTxt_fechaIni.get(), self.cajaTxt_fechaFin.get(), self.var_turno.get(), self.cajaTxt_gestion.get())
    ...
    def fModificar(self):
        ...
        if clave == '':
            ...
            self.var_carrera.set(valores[4])
            self.var_area.set(valores[5])
            self.cajaTxt_cel.insert(0, valores[6])
            self.var_tipoC.set(valores[7])
            self.cajaTxt_fechaIni.insert(0, valores[8])
            self.cajaTxt_fechaFin.insert(0, valores[9])
            self.var_turno.set(valores[10])
            self.cajaTxt_gestion.insert(0, valores[11])
    ...
    def create_widgets(self):
        ...
        self.var_carrera = StringVar(frame1)
        self.var_carrera.set('NINGUNO')
        self.opcionesCA = ['NINGUNO','COMUNICACION', 'INFORMATICA', 'TECNICA']
        self.opcionCA = OptionMenu(frame1, self.var_carrera, *self.opcionesCA)
        self.opcionCA.config(width=15)
        self.opcionCA.place(x=150, y=230)

        self.txt_area = Label(frame1, text="ÁREA :")
        self.txt_area.place(x=20, y=272)
        self.var_area = StringVar(frame1)
        self.var_area.set('NINGUNO')
        self.opcionesA = ['NINGUNO', 'ESTUDIO', 'PRENSA', 'PRODUCCION']
        self.opcionA = OptionMenu(frame1, self.var_area, *self.opcionesA)
        self.opcionA.config(width=15)
        self.opcionA.place(x=150, y=270)
        ...
        self.txt_tipoC.place(x=20, y=350)
        self.var_tipoC = StringVar(frame1)
        self.var_tipoC.set('TIPO CONTRATO')
        ...
        self.var_turno = StringVar(frame1)
        self.var_turno.set('NINGUNO')
        self.opcionesT = ['NINGUNO', 'MAÑANA', 'TARDE', 'COMPLETO']
        self.opcionT = OptionMenu(frame1, self.var_turno, *self.opcionesT)
        self.opcionT.config(width=15)
        self.opcionT.place(x=150, y=390)
        ...
        opciones2 = ['NINGUNO', 'INFORMATICA', 'TECNICA', 'COMUNICACION SOCIAL']
        ...
        opciones5 = ['2021', '2022', '2023', '2024', '2025', '2026', '2027', '2028', '2029',
        ...
        frame3.place(x=307, y=150, width=1035, height=332)
        # GRID
        ...
        self.grid.heading("col8", text="Gestion", anchor=CENTER)
        self.grid.heading("col9", text="FechaIni", anchor=CENTER)
        self.grid.heading("col10", text="FechaFin", anchor=CENTER)
        self.grid.heading("col11", text="Turno", anchor=CENTER)
        ...
        self.grid.place(x=0, y=0, width=1035, height=332)
