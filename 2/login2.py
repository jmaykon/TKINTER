...
class Login2(Frame):
    ...
    def widgets(self):
        ...
        Button(self.master, text='<-- VOLVER ATRAS', bg='gray', activebackground='#063374', bd=3, fg='white',
               font=('Lucida Sans', 15, 'italic'), command=self.fAtras).pack(pady=10)

        Button(self.master, text='Salir', bg='#063374', activebackground='blue', bd=4, fg='white',
