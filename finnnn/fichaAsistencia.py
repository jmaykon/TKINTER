...
class CAsistencia(Frame):  # Herencia Frame <-- Ventana
    ...
    def create_widgets(self):
        ...
        self.um = PhotoImage(file='registroPasantefondo.png')  # FONDO DENTRO DEL FRAME
        Label(frame1, image=self.um).place(x=70, y=50)

        self.titulo = Label(frame1, text="CONTROL DE ASISTENCIA", font=("Arial Black", 15), fg="black", bg="orange")
        self.titulo.place(x=320, y=35)

        self.btnBuscar = Button(frame1, text="Buscar",command=self.fbuscarCi, bg="green", fg="white")  # fNuevo
        self.btnBuscar.place(x=20, y=95, width=50, height=30)
        ...
        self.txt_ap_pat.place(x=320, y=162)
        self.cajaTxt_ap_pat.place(x=450, y=162)

        self.txt_ap_mat = Label(frame1, text="APELLIDO MATERNO :")
        self.cajaTxt_ap_mat = Entry(frame1, font="15", width=15)
        self.txt_ap_mat.place(x=620, y=162)
        self.cajaTxt_ap_mat.place(x=750, y=162)
        ...
        self.txt_area.place(x=320, y=222)
        self.cajaTxt_area.place(x=450, y=220)

        self.txt_turno = Label(frame1, text="TURNO :")
        self.cajaTxt_turno = Entry(frame1, font="15", width=15)
        self.txt_turno.place(x=620, y=222)
        self.cajaTxt_turno.place(x=750, y=220)

        ################# Asistencia #####################
        self.txt_fechaHoy = Label(frame1, text="Fecha Actual: ")
        self.txt_fechaHoy.place(x=620, y=100)
        self.cajaTxt_fechaA = Entry(frame1, font="15", width=10)
        self.cajaTxt_fechaA.place(x=720, y=100)
        # Fecha
        ...
        self.cajaTxt_horaS.place(x=470, y=325)

        self.txt_D = Label(frame1, text="Tiempo Acumulado:")
        self.txt_D.place(x=650, y=325)
        self.cajaTxt_horaD = Entry(frame1, font="15", width=15)
        self.cajaTxt_horaD.place(x=780, y=325)

        self.btnGuardarE = Button(frame1, text="Hora Entrada", command=self.fGuardarE, bg="blue", fg="white")  # fNuevo
        ...
        self.btnGuardarS.place(x=370, y=320, width=80, height=30)
    ...
    def fGuardarS(self):
        ...
        datos = self.a1.modificar_asistencia(self.cajaTxt_ci.get(), self.cajaTxt_horaE.get(), self.cajaTxt_horaS.get(),
    ...
    def fGuardarE(self):
        ...
        messagebox.showinfo("Hora de Entrada", "Registrado exitosamente, Hora de Entrada: "+a+ " con fecha: "+self.hoy)
        self.limpiarCaja()
    ...
    def fbuscarCi(self):
        ...
        try:
            ...
            self.limpiarHoraE()
            self.cajaTxt_horaE.insert(0, datosA[1])
