...
class Login(Frame):
    ...
    def widgets(self):
        Label(self.master, text='SISTEMA DE ASISTENCIA', bg='#a2b6d0', fg='black', font=('Lucida Sans', 16, 'bold')).pack(pady=5)
        Label(self.master, text='MCDyD', bg='#a2b6d0', fg='black',
        ...
        Button(self.master, text='ADMINISTRADOR', bg='orange', activebackground='blue', bd=0, fg='white',
               font=('Lucida Sans', 15, 'italic'), command=self.IrAlogin2).pack(pady=10)

        Button(self.master, text='ASISTENCIA DE PASANTES', bg='red2', activebackground='blue', bd=0, fg='white',
